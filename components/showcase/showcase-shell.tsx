...
{
  id: "sidebar",
  badge: "Desktop Navbar",
  badgeIcon: PanelLeft,
  badgeColor: "border-teal/30 bg-teal text-teal-foreground",
  title: "Floating Desktop Navigation",
  description:
    "The floating pill-shaped desktop navbar features navigation links, quick action icons, notifications badge, and an expandable user dropdown showing your level, dashboard access, and sign out option.",
  url: "gamejamcrew.com/find-members",
  cursorPosition: { x: "85%", y: "10%" },
  cursorLabel: "User menu open",
  ...
  },
{
  ...
  badgeIcon: Filter,
  badgeColor: "border-pink/30 bg-pink text-pink-foreground",
  title: "Select-Based Team Filters",
  description:
    "Filter teams by Engine, Role, Experience, and Language using Select dropdowns. Each filter shows options with checkmarks for the selected value, plus a Reset Filters button to clear all selections.",
  url: "gamejamcrew.com",
  cursorPosition: { x: "15%", y: "58%" },
  cursorLabel: "Engine dropdown open",
  ...
  },
{
  ...
  title: "Squad Chat & Overview Tabs",
  description:
    "Once you join a team, you gain access to the squad space with tabbed navigation between Squad Overview and Squad Chat. Real-time team communication with member avatars, roles, and info bar showing engine, language, and Discord link.",
  url: "gamejamcrew.com/teams/neon-runners",
  cursorPosition: { x: "60%", y: "25%" },
  cursorLabel: "Squad chat active",
  ...
  },
{
  ...
  title: "Slide-Out Mobile Navigation",
  description:
    "The mobile menu slides in from the right with your level badge, display name, title, Dashboard button and Sign Out. Navigation links include Find Teams, Find Members, Post a Team, and I'm Available.",
